...
import { queryRoleAllList, opinionList, addUserList, queryUserRoleInfo, updateUserList, queryAllNav } from '../services/opiononSave';
import { routerRedux } from 'dva/router';

export default {
  namespace: 'opiononsave',
  state: {
    loading:false,
    menulist:[],
    navlist:[],
  ...
  effects: {
    ...
    *fetch({ payload }, { call, put }){
      ...
      let response = yield call(opinionList,payload);
